...
do
	...
	../tsv_to_kmers/generate_random_seqs.py --seqDistr $GLOBAL_DISTR \
		--outputSeqs ${OUTPUT_DIR}${feature}_globalbackground_seqs.txt \
		--inputSeqs ${OUTPUT_DIR}${feature}_seqs.txt &
	# do with feature background distribution
	../tsv_to_kmers/generate_random_seqs.py --seqDistr ${OUTPUT_DIR}${feature}_distr.txt \
		--outputSeqs ${OUTPUT_DIR}${feature}_featurebackground_seqs.txt \
		--inputSeqs ${OUTPUT_DIR}${feature}_seqs.txt &
